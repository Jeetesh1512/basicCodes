...
static const char *const yytname[] =
{
  ...
  "MUL", "DIV", "MOD", "POW", "EXIT", "$accept", "input", "line",
...
#line 1135 "parser.tab.c"
  ...
  case 12: /* expression: expression POW expression  */
#line 53 "parser.y"
                                {
        if ((yyvsp[-2].num) == 0 && (yyvsp[0].num) == 0) {
            yyerror("Error: 0^0 is undefined.");
            (yyval.num) = 0;
        } else {
